...
## Kmeans
df <- read.csv("mm10_Heatmap_LastExon_200.csv", row.names = 1)
df = t(df)
df = data.frame(df)
...
my_sample_col$C[my_sample_col$Cluster==1] <- "C2"
my_sample_col$C[my_sample_col$Cluster==2] <- "C1"
...
# Heatmap of iM6A-WT
Cluster <- read.csv("Mouse_Cluster_LastExon.csv")
df <- read.csv("mm10_Heatmap_iM6A_LastExon_200.csv", row.names = 1)
df = t(df)
df = data.frame(df)
df$name <- row.names(df)
...
# Heatmap of iM6A-ID
Cluster <- read.csv("Mouse_Cluster_LastExon.csv")
df <- read.csv("mm10_Heatmap_iM6A_Mutation_LastExon_200.csv", row.names = 1)
df = t(df)
df = data.frame(df)
df$name <- row.names(df)
...
# Heatmap of RAC
Cluster <- read.csv("Mouse_Cluster_LastExon.csv")
df <- read.csv("mm10_Heatmap_RAC_LastExon_200.csv", row.names = 1)
df = t(df)
df = data.frame(df)
df$name <- row.names(df)
